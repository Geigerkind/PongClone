...
void move_Player(struct Player *p, int dirx, int diry){
  ...
  p->o.posx1 += dirx;
  p->o.posx2 += dirx;
  if ((checkCollosion(&p->o, &gv.neck.l1, 1)<360) || (checkCollosion(&p->o, &gv.neck.l3, 1)<360) || (checkCollosion(&p->o, &gv.neck.l5, 1)<360) || (checkCollosion(&p->o, &gv.neck.l7, 1)<360)){
    p->o.posy1 -= diry;
    p->o.posy2 -= diry;
    p->o.posx1 -= dirx;
    p->o.posx2 -= dirx;
...
void move_Ball(){
  float colangle;
  if ((colangle = checkCollosion(&gv.b.o, &gv.p1.o, 0))<360){
    gv.b.lastHit = &gv.p1;
    change_Ball_Direction(colangle);
  }
  if ((colangle = checkCollosion(&gv.b.o, &gv.p2.o, 0))<360){
    gv.b.lastHit = &gv.p2;
    change_Ball_Direction(colangle);
  }
  if ((colangle = checkCollosion(&gv.b.o, &gv.p3.o, 0))<360){
    gv.b.lastHit = &gv.p3;
    change_Ball_Direction(colangle);
  }
  if ((colangle = checkCollosion(&gv.b.o, &gv.p4.o, 0))<360){
    gv.b.lastHit = &gv.p4;
    change_Ball_Direction(colangle);
  }
  change_Ball_Direction(checkCollosion(&gv.b.o, &gv.neck.l1, 1));
  change_Ball_Direction(checkCollosion(&gv.b.o, &gv.neck.l3, 1));
  ...
  // Perc collosion
  if (checkCollosion(&gv.b.o, &gv.e1.o, 0)<360){
    int *sign = malloc(16);
    sign[0] = 1;
    sign[1] = -1;
  ...
  if (checkCollosion(&gv.b.o, &gv.e2.o, 0)<360){
  ...
  if (checkCollosion(&gv.b.o, &gv.e3.o, 0)<360){
    if (gv.b.lastHit != NULL){
      int *sign = malloc(16);
      sign[0] = 1;
      sign[1] = -1;
  ...
  if (checkCollosion(&gv.b.o, &gv.e4.o, 0)<360){
    gv.invert = -gv.invert;
    despawn_Perc(&gv.e4);
  }
  change_Ball_Direction(checkCollosion(&gv.b.o, &gv.e5.o, 0));
  if (checkCollosion(&gv.b.o, &gv.e6.o, 0)<360){
    gv.b.angle = rand()%360;
    despawn_Perc(&gv.e6);
  }
